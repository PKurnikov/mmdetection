...
from ..layers.transformer.dfine_utils import bbox2distance
from ..layers.transformer.box_ops import box_cxcywh_to_xyxy, box_iou, generalized_box_iou
...
class DFINECriterion(nn.Module):
    ...
    def __init__(self, \
        ...
        self.matcher = MODELS.build(matcher)#matcher
    ...
    def forward(self, outputs, targets, **kwargs):
        ...
        if 'aux_outputs' in outputs:
            ...
            #!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
            num_boxes_go = torch.clamp(num_boxes_go / 1, min=1).item() # get_world_size() = 1 !!!
        else:
        ...
        num_boxes = torch.clamp(num_boxes / 1, min=1).item() # get_world_size() !!!
